...
public class MailTemplateArray_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns3_myMailTemplate_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.MailTemplate.class, ns3_MailTemplate_TYPE_QNAME);
    }
    
    public java.lang.Object doDeserialize(XMLReader reader,
        SOAPDeserializationContext context) throws java.lang.Exception {
        jplagTutorial.jplagClient.MailTemplateArray instance = new jplagTutorial.jplagClient.MailTemplateArray();
        ...
        if ((reader.getState() == XMLReader.START) && (elementName.equals(ns1_items_QNAME))) {
            ...
            member = new jplagTutorial.jplagClient.MailTemplate[values.size()];
            member = values.toArray((Object[]) member);
            instance.setItems((jplagTutorial.jplagClient.MailTemplate[])member);
        }
        else {
            instance.setItems(new jplagTutorial.jplagClient.MailTemplate[0]);
        }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        jplagTutorial.jplagClient.MailTemplateArray instance = (jplagTutorial.jplagClient.MailTemplateArray)obj;
