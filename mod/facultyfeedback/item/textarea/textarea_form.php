...
class facultyfeedback_textarea_form extends facultyfeedback_item_form {
    ...
    public function definition() {
        ...
        $mform->addElement('select',
                            'itemwidth',
                            get_string('textarea_width', 'facultyfeedback').'&nbsp;',
                            array_slice(range(0, 80), 5, 80, true));

        $mform->addElement('select',
                            'itemheight',
                            get_string('textarea_height', 'facultyfeedback').'&nbsp;',
