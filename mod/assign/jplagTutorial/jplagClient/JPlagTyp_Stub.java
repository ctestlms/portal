...
public class JPlagTyp_Stub
    ...
    implements jplagTutorial.jplagClient.JPlagTyp {
    ...
    public byte[] continueResultDownload(int dummy)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/continueResultDownload");
        ...
        } catch (jplagTutorial.jplagClient.JPlagException e) {
            throw e;
     ...
     */
    public int finishAccountRequest(jplagTutorial.jplagClient.FinishRequestData finishData)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/finishAccountRequest");
    ...
    public int continueSubmissionUpload(byte[] data)
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/continueSubmissionUpload");
     ...
     */
    public jplagTutorial.jplagClient.Status getStatus(java.lang.String submissionID)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/getStatus");
            
            _send((java.lang.String) _getProperty(ENDPOINT_ADDRESS_PROPERTY), _state);
            
            jplagTutorial.jplagClient.Status _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (jplagTutorial.jplagClient.Status)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (jplagTutorial.jplagClient.Status)_responseObj;
            }
     ...
     */
    public java.lang.String compareSource(jplagTutorial.jplagClient.Option arguments, javax.mail.internet.MimeMultipart inputZipFile)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/compareSource");
     ...
     */
    public jplagTutorial.jplagClient.MailTemplateArray getMailTemplates(int type)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/getMailTemplates");
            
            _send((java.lang.String) _getProperty(ENDPOINT_ADDRESS_PROPERTY), _state);
            
            jplagTutorial.jplagClient.MailTemplateArray _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (jplagTutorial.jplagClient.MailTemplateArray)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (jplagTutorial.jplagClient.MailTemplateArray)_responseObj;
            }
     ...
     */
    public int setUserData(jplagTutorial.jplagClient.SetUserDataParams params)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/setUserData");
     ...
     */
    public int updateUserInfo(jplagTutorial.jplagClient.UpdateUserInfoParams params)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/updateUserInfo");
    ...
    public javax.mail.internet.MimeMultipart getResult(java.lang.String submissionID)
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/getResult");
     ...
     */
    public boolean requestAccount(jplagTutorial.jplagClient.RequestData params)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/requestAccount");
     ...
     */
    public java.lang.String startSubmissionUpload(jplagTutorial.jplagClient.StartSubmissionUploadParams params)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/startSubmissionUpload");
     ...
     */
    public jplagTutorial.jplagClient.UserDataArray getUserDataArray(int dummy)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/getUserDataArray");
            
            _send((java.lang.String) _getProperty(ENDPOINT_ADDRESS_PROPERTY), _state);
            
            jplagTutorial.jplagClient.UserDataArray _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (jplagTutorial.jplagClient.UserDataArray)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (jplagTutorial.jplagClient.UserDataArray)_responseObj;
            }
     ...
     */
    public int notifyDevelopers(jplagTutorial.jplagClient.NotifyDevelopersParams params)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/notifyDevelopers");
     ...
     */
    public jplagTutorial.jplagClient.RequestDataArray getAccountRequests(boolean lengthOnly)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/getAccountRequests");
            
            _send((java.lang.String) _getProperty(ENDPOINT_ADDRESS_PROPERTY), _state);
            
            jplagTutorial.jplagClient.RequestDataArray _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (jplagTutorial.jplagClient.RequestDataArray)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (jplagTutorial.jplagClient.RequestDataArray)_responseObj;
            }
     ...
     */
    public jplagTutorial.jplagClient.ServerInfo getServerInfo()
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            jplagTutorial.jplagClient.ServerInfo _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (jplagTutorial.jplagClient.ServerInfo)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (jplagTutorial.jplagClient.ServerInfo)_responseObj;
            }
     ...
     */
    public jplagTutorial.jplagClient.StartResultDownloadData startResultDownload(java.lang.String submissionID)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/startResultDownload");
            
            _send((java.lang.String) _getProperty(ENDPOINT_ADDRESS_PROPERTY), _state);
            
            jplagTutorial.jplagClient.StartResultDownloadData _result = null;
            java.lang.Object _responseObj = _state.getResponse().getBody().getValue();
            if (_responseObj instanceof SOAPDeserializationState) {
                _result = (jplagTutorial.jplagClient.StartResultDownloadData)((SOAPDeserializationState) _responseObj).getInstance();
            } else {
                _result = (jplagTutorial.jplagClient.StartResultDownloadData)_responseObj;
            }
    ...
    public int cancelSubmission(java.lang.String submissionID)
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/cancelSubmission");
     ...
     */
    public int setDeveloperState(jplagTutorial.jplagClient.SetDeveloperStateParams params)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/setDeveloperState");
     ...
     */
    public int setMailTemplate(jplagTutorial.jplagClient.SetMailTemplateParams params)
        throws jplagTutorial.jplagClient.JPlagException, java.rmi.RemoteException {
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/setMailTemplate");
    ...
    public int extendAccount(java.lang.String extendCode)
        ...
        try {
            ...
            _state.getMessageContext().setProperty(HttpClientTransport.HTTP_SOAPACTION_PROPERTY, "http://jplag.ipd.kit.edu/JPlagService/extendAccount");
    ...
    public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_myOption_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.Option.class, ns1_Option_TYPE_QNAME);
        ns2_myns2__int__int_Int_Serializer = (CombinedSerializer)registry.getSerializer("", int.class, ns2_int_TYPE_QNAME);
        ns1_myUpdateUserInfoParams_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.UpdateUserInfoParams.class, ns1_updateUserInfoParams_TYPE_QNAME);
        ns1_myFinishRequestData_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.FinishRequestData.class, ns1_FinishRequestData_TYPE_QNAME);
        ns1_myRequestDataArray_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.RequestDataArray.class, ns1_RequestDataArray_TYPE_QNAME);
        ns1_myStatus_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.Status.class, ns1_Status_TYPE_QNAME);
        ns1_myServerInfo_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.ServerInfo.class, ns1_ServerInfo_TYPE_QNAME);
        ns1_myUserDataArray_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.UserDataArray.class, ns1_UserDataArray_TYPE_QNAME);
        ns1_mySetDeveloperStateParams_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.SetDeveloperStateParams.class, ns1_setDeveloperStateParams_TYPE_QNAME);
        ns1_myNotifyDevelopersParams_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.NotifyDevelopersParams.class, ns1_notifyDevelopersParams_TYPE_QNAME);
        ...
        ns1_mySetUserDataParams_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.SetUserDataParams.class, ns1_setUserDataParams_TYPE_QNAME);
        ns1_myMailTemplateArray_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.MailTemplateArray.class, ns1_MailTemplateArray_TYPE_QNAME);
        ns1_myRequestData_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.RequestData.class, ns1_RequestData_TYPE_QNAME);
        ...
        ns1_myStartSubmissionUploadParams_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.StartSubmissionUploadParams.class, ns1_startSubmissionUploadParams_TYPE_QNAME);
        ...
        ns1_mySetMailTemplateParams_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.SetMailTemplateParams.class, ns1_setMailTemplateParams_TYPE_QNAME);
        ns1_myStartResultDownloadData_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.StartResultDownloadData.class, ns1_startResultDownloadData_TYPE_QNAME);
    ...
    private static final javax.xml.namespace.QName _portName = new QName("http://jplag.ipd.kit.edu/JPlagService", "JPlagServicePort");
    private static final int continueResultDownload_OPCODE = 0;
    private static final int finishAccountRequest_OPCODE = 1;
    private static final int continueSubmissionUpload_OPCODE = 2;
    private static final int getStatus_OPCODE = 3;
    private static final int compareSource_OPCODE = 4;
    private static final int getMailTemplates_OPCODE = 5;
    private static final int setUserData_OPCODE = 6;
    private static final int updateUserInfo_OPCODE = 7;
    private static final int getResult_OPCODE = 8;
    private static final int requestAccount_OPCODE = 9;
    private static final int startSubmissionUpload_OPCODE = 10;
    private static final int getUserDataArray_OPCODE = 11;
    private static final int notifyDevelopers_OPCODE = 12;
    private static final int getAccountRequests_OPCODE = 13;
    private static final int getServerInfo_OPCODE = 14;
    private static final int startResultDownload_OPCODE = 15;
    private static final int cancelSubmission_OPCODE = 16;
    private static final int setDeveloperState_OPCODE = 17;
    private static final int setMailTemplate_OPCODE = 18;
    private static final int extendAccount_OPCODE = 19;
    private final CombinedSerializer myJPlagTyp_continueResultDownload_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_continueResultDownload_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_finishAccountRequest_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_finishAccountRequest_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_continueSubmissionUpload_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_continueSubmissionUpload_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_getStatus_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_getStatus_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_compareSource_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_compareSource_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_getMailTemplates_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_getMailTemplates_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_setUserData_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_setUserData_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_updateUserInfo_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_updateUserInfo_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_getResult_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_getResult_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_requestAccount_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_requestAccount_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_startSubmissionUpload_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_startSubmissionUpload_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_getUserDataArray_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_getUserDataArray_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_notifyDevelopers_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_notifyDevelopers_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_getAccountRequests_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_getAccountRequests_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_getServerInfo_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_getServerInfo_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_startResultDownload_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_startResultDownload_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_cancelSubmission_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_cancelSubmission_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_setDeveloperState_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_setDeveloperState_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_setMailTemplate_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_setMailTemplate_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
    private final CombinedSerializer myJPlagTyp_extendAccount_Fault_SOAPSerializer = new ReferenceableSerializerImpl(DONT_SERIALIZE_AS_REF,
        new jplagTutorial.jplagClient.JPlagTyp_extendAccount_Fault_SOAPSerializer(ENCODE_TYPE, NOT_NULLABLE));
