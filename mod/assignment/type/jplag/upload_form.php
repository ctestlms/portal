 ...
 */
class mod_assignment_jplag_form extends moodleform {
	function definition() {
		...
		$mform->addElement('filemanager', 'files_filemanager', get_string('uploadafile'), null,
                    array('accepted_types' => array('*.java', '*.cs','*.txt','*.c','*.cpp') ));
