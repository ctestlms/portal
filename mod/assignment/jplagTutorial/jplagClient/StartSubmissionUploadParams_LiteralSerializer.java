...
public class StartSubmissionUploadParams_LiteralSerializer extends LiteralObjectSerializerBase implements Initializable  {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ns3_myOption_LiteralSerializer = (CombinedSerializer)registry.getSerializer("", jplagTutorial.jplagClient.Option.class, ns3_Option_TYPE_QNAME);
    ...
    public java.lang.Object doDeserialize(XMLReader reader,
        ...
        jplagTutorial.jplagClient.StartSubmissionUploadParams instance = new jplagTutorial.jplagClient.StartSubmissionUploadParams();
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_submissionParams_QNAME)) {
                ...
                instance.setSubmissionParams((jplagTutorial.jplagClient.Option)member);
                reader.nextElementContent();
            } else {
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        jplagTutorial.jplagClient.StartSubmissionUploadParams instance = (jplagTutorial.jplagClient.StartSubmissionUploadParams)obj;
