...
//Added By Hina Yousuf
        $_SESSION['course'] = $this->assignment->get_course()->id;
        $_SESSION['cm'] = $this->assignment->get_course_module()->id;
        $_SESSION['assignmentid'] = $this->assignment->get_instance()->id;
        $_SESSION['assignmentname'] =$this->assignment->get_instance()->name;
//end
    ...
    public function upgrade(context $oldcontext, stdClass $oldassignment, stdClass $oldsubmission, stdClass $submission, & $log) {
        ...
        $this->assignment->copy_area_files_for_upgrade($oldcontext->id, 'mod_assignment', 'submission', $oldsubmission->id,
                // New file area
                $this->assignment->get_context()->id, 'assignsubmission_file', ASSIGNSUBMISSION_FILE_FILEAREA, $submission->id);
