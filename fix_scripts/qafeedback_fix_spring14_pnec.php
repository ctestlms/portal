...
require_login();	
$springsemstartdate = mktime(0, 0, 0, 1, 27, 2014);

$school = $DB->get_record_sql("select id, name from {course_categories} where name='Pakistan Navy Engineering College (PNEC)'");
