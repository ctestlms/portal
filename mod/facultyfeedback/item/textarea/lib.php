...
class facultyfeedback_item_textarea extends facultyfeedback_item_base {
    ...
    public function build_editform($item, $facultyfeedback, $cm) {
        ...
        $this->item_form = new facultyfeedback_textarea_form('edit_item.php', $customdata);
    }
...
//            }
    ...
    public function print_item_preview($item) {
        ...
        echo '<span class="facultyfeedback_item_textarea">';
