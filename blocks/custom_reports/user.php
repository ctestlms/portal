...
$catg = optional_param('schoolid', 0, PARAM_INT);
$batch = optional_param('batch', "", PARAM_ALPHANUM);
$status = optional_param('status', "", PARAM_TEXT);

//admin_externalpage_setup('editusers');
//$catg = 657;
$catcontext = get_context_instance(CONTEXT_COURSECAT, $catg);

$sitecontext = context_system::instance();
$site = get_site();

if (!has_capability('moodle/user:update', $catcontext) and !has_capability('moodle/user:delete', $catcontext)) {
...
$return_url = new moodle_url('/blocks/custom_reports/std_reg_rept.php', array('batch' => "$batch",'catg' => $catg,'status' => $status));
$returnurl = new moodle_url('/blocks/custom_reports/user.php', array('schoolid' => $catg,'batch' => "$batch",'status' => "$status"));

if ($confirmuser and confirm_sesskey()) {
    require_capability('moodle/user:update', $catcontext);
    ...
    require_capability('moodle/user:delete', $catcontext);
    ...
    if (!has_capability('moodle/user:update', $catcontext)) {
