<?php
  ...
  $action = optional_param('action', 'editpoll', PARAM_ALPHA);
  ...
  //$action = 'responses'; // testing used - ** 'editpoll', 'managepolls', 'responses'
