...
/**
 * deletes an item of the facultyfeedback
 *
...
$PAGE->set_url('/mod/facultyfeedback/delete_item.php', array('id'=>$id, 'deleteitem'=>$deleteitem));
...
$mform = new mod_facultyfeedback_delete_item_form();
...
if (isset($formdata->confirmdelete) AND $formdata->confirmdelete == 1) {
    facultyfeedback_delete_item($formdata->deleteitem);
    redirect('edit.php?id=' . $id);
}
...
$PAGE->navbar->add(get_string('delete_item', 'facultyfeedback'));
...
echo $OUTPUT->heading(get_string('confirmdeleteitem', 'facultyfeedback'));
print_string('relateditemsdeleted', 'facultyfeedback');
$mform->display();
echo $OUTPUT->box_end();
