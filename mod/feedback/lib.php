...
function feedback_load_xml_datap($xmlcontent) {
        global $CFG;

        require_once($CFG->dirroot.'/lib/xmlize.php');

        if(!$xmlcontent = feedback_check_xml_utf8p($xmlcontent)) return false;
...
function feedback_import_loaded_datap(&$data, $feedbackid){
        global $CFG, $DB;
...
function feedback_check_xml_utf8p($text) {
        //find the encoding
