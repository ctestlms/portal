...
$string['enroledinanothersection'] = 'You are enrolled in another section of the same course.';
$string['enroledinanotherelective1'] = 'You are already enrolled in two electives.';
...
$string['schedule_clash1'] = 'You are having course schedule clash with {$a->clash_with}';
