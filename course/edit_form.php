...
//--------------------------------------------------------------------------------
        ...
        $mform->addElement('select', 'credithours', get_string('credithours'), $credithoursmenu);
        $mform->addHelpButton('credithours', 'credithours');
        //end
        $options = range(0, 10);
...
//end
        ...
        if (is_array($formatvalue) && !empty($formatvalue)) {
            ...
            $newel = $mform->createElement('header', '', get_string('courseformatoptions', 'moodle', $courseformat->get_format_name()));
