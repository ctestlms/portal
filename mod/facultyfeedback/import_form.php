...
class facultyfeedback_import_form extends moodleform {
    public function definition() {
        ...
        $strdeleteolditmes = get_string('delete_old_items', 'facultyfeedback').
                             ' ('.get_string('oldvalueswillbedeleted', 'facultyfeedback').')';

        $strnodeleteolditmes = get_string('append_new_items', 'facultyfeedback').
                               ' ('.get_string('oldvaluespreserved', 'facultyfeedback').')';
