...
class facultyfeedback_item_numeric extends facultyfeedback_item_base {
    ...
    public function init() {
        $this->sep_dec = get_string('separator_decimal', 'facultyfeedback');
        if (substr($this->sep_dec, 0, 2) == '[[') {
            $this->sep_dec = FEEDBACK_DECIMAL;
        }

        $this->sep_thous = get_string('separator_thousand', 'facultyfeedback');
    ...
    public function build_editform($item, $facultyfeedback, $cm) {
        ...
        $this->item_form = new facultyfeedback_numeric_form('edit_item.php', $customdata);
    }
    ...
    public function print_analysed($item, $itemnr = '', $groupid = false, $courseid = false) {
        ...
        if (isset($values->data) AND is_array($values->data)) {
            ...
            echo get_string('average', 'facultyfeedback').': '.$avg;
            echo '</b></td></tr>';
        }
    }
