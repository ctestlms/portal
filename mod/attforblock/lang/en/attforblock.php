...
$string['attforblock:unmarkattendances'] = 'Unmarking Attendance';
...
$string['enrolmentstarttest'] = 'User enrolment starts testttttt {$a}';
...
$string['sessiondate'] = 'Session Date and Time';
...
$string['sessionsperday'] = 'Sessions Per Day';
...
//TO SHOW IN LIST BOX
$string['fiftyminclass'] = '50-Mins/One Hour Lecture';
$string['ninetyminsclass'] = '90-Mins Lecture';
$string['twohoursclass'] = 'Two Hours Lecture';
$string['threehoursclass'] = 'Three Hours Lecture';
$string['onehourlab'] = 'One Hour Lab';
$string['twohourslab'] = 'Two Hours Lab';
$string['threehourslab'] = 'Three Hours Lab';
$string['twohoursstudio'] = 'Two Hours Studio';
$string['threehoursstudio'] = 'Three Hours Studio';
$string['ward'] = 'Ward';
$string['twohoursward'] = 'Two Hours Ward';
$string['fourhoursward'] = 'Four Hours Ward';
$string['lecture'] = 'Lecture';
$string['lab'] = 'Lab';
$string['studio'] = 'Studio';

$string['description_help'] = '<ul>
	<li><strong>50-Mins/One Hour Lecture: </strong> 1-Credit Hour (for one hour class as followed in SEECS/AMC)</li>
	<li><strong>90-Mins Lecture: </strong> 1.5-Credit Hour</li>
	<li><strong>Two Hours Lecture: </strong> 2-Credit Hours</li>
	<li><strong>Three Hours Lecture: </strong> 3-Credit Hours (for three hour class as followed in NBS)</li>
	<li><strong>One Hour Lab: </strong> 1-Credit Hour (for Labs as followed in AMC)</li>
	<li><strong>Two Hours Lab: </strong> 1-Credit Hour (for Labs as followed in Engineering & Medical Schools)</li>
	<li><strong>Three Hours Lab: </strong> 1-Credit Hour (for Labs as followed in Engineering & Medical Schools)</li>
	<li><strong>Two Hours Studio: </strong> 1-Credit Hour (for Practical work as followed in SADA)</li>
	<li><strong>Three Hours Studio: </strong> 1.5-Credit Hour (for Practical work as followed in SADA)</li>
	<li><strong>Two Hours Ward: </strong> 2-Contact Hours (for Clinical work as followed in AMC)</li>
	<li><strong>Four Hours Ward: </strong> 4-Contact Hours (for Clinical work as followed in AMC)</li>
</ul>';
