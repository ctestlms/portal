...
class facultyfeedback_item_multichoice extends facultyfeedback_item_base {
    ...
    public function build_editform($item, $facultyfeedback, $cm) {
        ...
        $this->item_form = new facultyfeedback_multichoice_form('edit_item.php', $customdata);
    }
        ...
        if ($info->subtype == 'c') {
            ...
            foreach ($presentation as $pres) {
                foreach ($values as $val) {
                    if ($val == $index) {
                        echo '<div class="facultyfeedback_item_multianswer">';
    ...
    private function print_item_check($presentation, $item, $value, $info, $align) {
        ...
        ?>
            <li class="facultyfeedback_item_check_<?php echo $hv.'_'.$align;?>">
                <span class="facultyfeedback_item_check_<?php echo $hv.'_'.$align;?>">
                    <?php
