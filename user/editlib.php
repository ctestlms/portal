...
function useredit_shared_definition(&$mform, $editoroptions = null, $filemanageroptions = null) {
    ...
    $mform->addElement('text', 'fathername',  get_string('fathername'),  'maxlength="100" size="30"');
    $mform->addRule('fathername', $strrequired, 'required', null, 'client');
    $mform->setType('fathername', PARAM_NOTAGS);
    ...
    if (!empty($CFG->emailchangeconfirmation) and !empty($user->preference_newemail)) {
     ...
     //Added By Hina Yousuf on 19/2/2012
        $mform->addElement('text', 'phone2', "Mobile Phone", 'maxlength="16" size="25"');
        $mform->setType('phone2', PARAM_NOTAGS);
        $mform->addRule('phone2', $strrequired, 'required', null, 'client');
        $mform->addElement('html', '<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;e.g(03216675787)</b>');
...
//$mform->addElement('static', 'imp', '<b>Note For New Students:</b>','<font color="red">Please bring a hard-copy of your picture as mentioned in the Required Documents, your picture will not not be uploaded here.</font>');
   ...
   $mform->addElement('text', 'idnumber', 'Registration No.', 'maxlength="255" size="25"');
   ...
   // $mform->setType('phone1', PARAM_NOTAGS);
    ...
    $mform->addElement('text', 'address', 'Current Address', 'maxlength="70" size="25"');
    $mform->setType('address', PARAM_TEXT);
    $mform->addRule('address', $strrequired, 'required', null, 'client');//Added By Hina Yousuf

if($DB->record_exists('regform',array('userid'=>$USER->id,'freeze_edit'=>1))){
    $mform->hardFreeze('phone2');
    $mform->hardFreeze('address');
    $mform->hardFreeze('firstname');
    $mform->hardFreeze('lastname');
    $mform->hardFreeze('fathername');
