    ...
    public function definition() {
	   ...
	   //--------------CHECK FOR CLASH COURSES-----------------
			...
			if($DB->record_exists_sql($sql3)){
				...
				//$conflict  =   file_get_contents("http://localhost/lms_live/portal/course_manager/index.php/schedules/checkClash/$courseslist2/$course_shortname1");
