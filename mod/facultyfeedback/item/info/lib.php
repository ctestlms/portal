...
class facultyfeedback_item_info extends facultyfeedback_item_base {
    protected $type = "info";
    ...
    public function build_editform($item, $facultyfeedback, $cm) {
        ...
        //build the form
        $this->item_form = new facultyfeedback_info_form('edit_item.php',
                                                  array('item'=>$item,
                                                  'common'=>$commonparams,
    ...
    public function print_item_preview($item) {
        ...
        if ($item->facultyfeedback) {
            $courseid = $DB->get_field('facultyfeedback', 'course', array('id'=>$item->facultyfeedback));
        ...
        echo '<span class="facultyfeedback_item_info">'.$itemshowvalue.'</span>';
        echo '</div>';
    }
    ...
    public function print_item_complete($item, $value = '', $highlightrequire = false) {
        ...
        $facultyfeedback = $DB->get_record('facultyfeedback', array('id'=>$item->facultyfeedback));
