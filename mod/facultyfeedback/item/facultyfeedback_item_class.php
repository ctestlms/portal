...
abstract class facultyfeedback_item_base {
    protected $type;
    ...
    abstract public function build_editform($item, $facultyfeedback, $cm);
     ...
     * @param object $item the db-object from facultyfeedback_item
    ...
    /**
     * @param $item the db-object from facultyfeedback_item
     * @param string $itemnr
     * @param integer $groupid
     * @param integer $courseid
    ...
    /**
     * @param object $item the db-object from facultyfeedback_item
     * @param string $value a item-related value from facultyfeedback_values
     * @return string
     */
...
class facultyfeedback_item_pagebreak extends facultyfeedback_item_base {
