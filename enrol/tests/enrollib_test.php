...
class core_enrol_testcase extends advanced_testcase {
    ...
    public function test_enrol_teacher_autocreate_feedback_activity() {
        global $DB, $CFG;
        ...
        $feedbacks = $DB->get_records('feedback', array('course' => $course1->id));
        foreach ($feedbacks as $feedback) {
            $this->assertEquals($course1->id, $feedback->course);
        }
