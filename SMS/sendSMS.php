...
//$con = mysql_connect('localhost', 'root', 'CDE@456q'); // makes a connection to the DB
...
if (!$con) {
	...
	$sql = "SELECT * from mdl_sms_msg where Date = CURDATE()";
	...
	*/
	...
	$msgid = mysql_query("Select Msg_Id, Date from mdl_sms_msg where Date = curdate()") or die(mysql_error());
	//echo "Here....";
	$msgid_arr = array();
	$i=0;
