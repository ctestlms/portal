...
/// If a file has been uploaded, then process it
    ...
    if ($um->preprocess_files()) {
        ...
        //TODO: validate if the filetype is excel or not
        ...
        // Instantiate csv array
        $csv = array();
        
        // Hard code csv headings
        $csv[] = array('category','format','numsections','fullname','shortname','credithours','startdate');
        
        // Put excel data into an array
        $array_data = array();
...
<tr><td>shortname</td><td>String(30)</td></tr>
