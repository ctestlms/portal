...
abstract class enrol_plugin {
    ...
    /**
        ...
        public function add_defaulter( $userid,  $timestart = 0, $timeend = 0, $status = NULL) {
                global $DB, $USER, $CFG; // CFG necessary!!!
                $ue=new stdClass();
                $ue->id                 = $userid;
                $ue->defaulter   = 1;

                $DB->update_record('user', $ue);
        }

      /**
         * set user as non-fee defaulter
         *
        ...
        public function remove_defaulter( $userid) {
                global $DB, $USER, $CFG; // CFG necessary!!!
                $ue=new stdClass();
                $ue->id                 = $userid;
                $ue->defaulter   = 0;
