...
$PAGE->set_url('/mod/facultyfeedback/item/captcha/print_captcha.php', array('id'=>$id));
...
if (!isset($SESSION->facultyfeedback->item->captcha)) {
    print_error('captchanotset', 'facultyfeedback');
}

$height = 40;
$charcount = $SESSION->facultyfeedback->item->captcha->charcount;
...
$SESSION->facultyfeedback->item->captcha->checkchar = $checkchar;
