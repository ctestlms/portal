...
The OSP plugin for Moodle is free software: you can redistribute it and/or modify 
...
If you downloaded this plugin from github, you will need to change the folder's 
name to osp. If you downloaded it from Moodle.org, then you are fine.

This is a reposiroty plugin for Moodle so you should place the ejsapp folder in 
your /repository folder, inside you Moodle installation. This module has been 
tested in all Moodle 2.x versions.
