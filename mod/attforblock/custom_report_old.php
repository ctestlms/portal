<?php
	...
	if($courses = get_courses($categoryid, '', 'c.id, c.fullname, c.startdate, c.idnumber, c.shortname')){
...
//			echo '<div style="text-align: left; padding-left: 150px; text-decoration: underline;">Duration :- '.date("d M Y", $cselected["startdate"][0]).' to '.date("d M Y", time('now')).'</div>';
