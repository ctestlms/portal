...
class facultyfeedback_textfield_form extends facultyfeedback_item_form {
    ...
    public function definition() {
        ...
        $mform->addElement('select',
                            'itemsize',
                            get_string('textfield_size', 'facultyfeedback').'&nbsp;',
                            array_slice(range(0, 255), 5, 255, true));

        $mform->addElement('select',
                            'itemmaxlength',
                            get_string('textfield_maxlength', 'facultyfeedback').'&nbsp;',
                            array_slice(range(0, 255), 5, 255, true));
