...
$row_offset1 = 0;
$worksheet1->write_string($row_offset1++, 4, $feedback->name, $xls_formats->head1);//Added By Hina Yousuf
...
//$worksheet1->write_string(3, 0, "Course:" . $coursename, $xls_formats->head1);
//$row_offset1++;
