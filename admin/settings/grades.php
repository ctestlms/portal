...
if (has_capability('moodle/grade:manage', $systemcontext)
 or has_capability('moodle/grade:manageletters', $systemcontext)) { // speedup for non-admins, add all caps used on this page
    ...
    if ($ADMIN->fulltree) {
        ...
        $temp->add(new admin_setting_configselect('coursetotal_grade_displaytype', new lang_string('coursetotalgradedisplaytype', 'grades'),
                        new lang_string('coursetotalgradedisplaytype_help', 'grades'), GRADE_DISPLAY_TYPE_REAL, $display_types));
