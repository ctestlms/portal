...
a) the "activity" facultyfeedback (required)
b) the "sideblock" facultyfeedback (optional)
...
an central placed facultyfeedback-activity. So you can create one facultyfeedback on the main site of moodle and then publish
it in many courses.
...
------------
   ...
   copy the folder facultyfeedback.zip/mod/facultyfeedback --> moodle/mod/facultyfeedback
   and the folder facultyfeedback.zip/blocks/facultyfeedback --> moodle/blocks/facultyfeedback
   The langfiles normaly can be left into the folder mod/facultyfeedback/lang.
   The only exception is the facultyfeedback-block. The langfile is block_facultyfeedback.php and
...
-----------------------
   1. create one or more new facultyfeedback-activitys on the moodle main-site
   2. go into some course and enable the facultyfeedback-block. This block now shows the facultyfeedbacks from the main-site.
   3. login as student and go into the course where the facultyfeedback-block is enabled
   4. fill out the facultyfeedback chosen from block
   5. login as admin and look at the facultyfeedback you created above
...
03.04.2008
- anonymous facultyfeedback was send the userid on email-notification
...
03.12.2007
- changing the table facultyfeedback_template, field public -> ispublic, public is reserved in oracle
...
11.09.2007
- Update facultyfeedback settings has help showing wrongly
...
- missing sesskey checks in facultyfeedback
- uninitialised $filename when importing into facultyfeedback
...
09.05.2007
- added two columns (random_response,anonymous_response) to facultyfeedback_complete and facultyfeedback_complete_tmp
- userids now will be logged even if the facultyfeedback is anonymous so you now can filter by group
...
- a facultyfeedback what is switch to the next page is saved temporary.
  the user can cancel the completion and later continue at the last filled page.
- now you can ex-/import facultyfeedbacks into/from a xml-file
...
02.06.2006 21:22
several bugfixes
improve the block "facultyfeedback"

20.05.2006 01:00
adding the block "facultyfeedback" to publish facultyfeedback over all courses
Thanks to Jun Yamog!
...
21.04.2006 16:00
version 2006042101
prefixed all function-names like "facultyfeedback_"
...
function facultyfeedback_action_handler() argument list changed
...
If facultyfeedback is not anonym now guest is it not allowed to fill it out

11.08.2005 22:00
added email-notification
anonymous facultyfeedbacks can be filled out by anonymous users

03.08.2005 01:20
item specific functions were moved into the items-librarys
now developers can create individual facultyfeedback-items
