...
public class ExampleClient {
    ...
    private String sendSubmission() {
        ...
        try {
			...
			// Updated by Qurrat-ul-ain 12th June, 2013
			// commented out to remove the text progress bar from printing
    ...
    private boolean checkOptions(ServerInfo info) {
        ...
        if(suffixes == null) {
            ...
            //System.out.println("Using default suffixes: " + arrayToString(suffixes));
        }
    ...
    public void run(String[] args) {
        ...
        //java -Dhttps.proxyHost=10.1.11.10 -Dhttps.proxyPort=8080 -jar dist/exampleClient.jar -user <your username> -pass <your password> -l java15 .
        System.out.println("The result files are available in \"" + resultDirName + "\"");
    }
