...
class assignment_base {
    ...
    /// Check to see if groups are being used in this assignment
       ...
       // $table->column_class('idnumber', 'fulln');
...
function assignment_extend_settings_navigation(settings_navigation $settings, navigation_node $assignmentnode) {
    ...
    function course_material($course){
        ...
        $file_records= $DB->get_records_sql("SELECT f.*
                                                ...
                                                AND (cm.availablefrom = 0 OR cm.availablefrom < $time)
                                                AND (cm.availableuntil = 0 OR cm.availableuntil > $time)
                                                AND cm.visible = 1");
        $result = array();
