...
$string['admintreelabel'] = 'Rappels d\'&eacute;v&eacute;nement';
$string['contentdescription'] = 'Description';
$string['contenttypecourse'] = 'Cours';
$string['contenttypeactivity'] = 'Activit&eacute;';
$string['contenttypegroup'] = 'Groupe';
$string['contenttypeuser'] = 'Utilisateur';
$string['contentwhen'] = 'Quand';
$string['courseheading'] = 'Rappels d\'&eacute;v&eacute;nement de Cours';
...
$string['explainuserheading'] = 'Param&egrave;tres de rappel pour les &eacute;v&eacute;nements utilisateur. Ces &eacute;v&eacute;nements sont propres &agrave; chaque utilisateur.';
$string['filterevents'] = 'Filtre des &eacute;v&eacute;nements du calendrier:';
$string['filtereventsdescription'] = 'Choix des &eacute;v&eacute;nements du calendrier &agrave; filtrer pour les rappels.';
$string['filtereventsonlyhidden'] = 'Seulement les &eacute;v&eacute;nements masqu&eacute;s du calendrier';
$string['filtereventsonlyvisible'] = 'Seulement les &eacute;v&eacute;nements visibles du calendrier';
...
$string['siteheading'] = 'Rappel d\'&eacute;v&eacute;nement de Site';
$string['titlesubjectprefix'] = 'Rappel';
$string['userheading'] = 'Rappels d\'&eacute;v&eacute;nement Utilisateur';
